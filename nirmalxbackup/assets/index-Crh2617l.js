...
`;var w=function(t,e,i,r){var n=arguments.length,l=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,i,r);else for(var h=t.length-1;h>=0;h--)(a=t[h])&&(l=(n<3?a(l):n>3?a(e,i,l):a(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};const b1={primary:f.tokens.theme.textPrimary,secondary:f.tokens.theme.textSecondary,tertiary:f.tokens.theme.textTertiary,invert:f.tokens.theme.textInvert,error:f.tokens.core.textError,success:f.tokens.core.textSuccess,warning:f.tokens.core.textWarning,"accent-primary":f.tokens.core.textAccentPrimary};let C=class extends x{constructor(){super(...arguments),this.variant="md-regular",this.color="inherit",this.align="left",this.lineClamp=void 0,this.display="inline-flex"}render(){const e={[`wui-font-${this.variant}`]:!0,[`wui-line-clamp-${this.lineClamp}`]:!!this.lineClamp};return this.style.cssText=`
      ...
      `,E`<slot class=${P1(e)}></slot>`}};C.styles=[y,V1];w([c()],C.prototype,"variant",void 0);w([c()],C.prototype,"color",void 0);w([c()],C.prototype,"align",void 0);w([c()],C.prototype,"lineClamp",void 0);w([c()],C.prototype,"display",void 0);C=w([P("wui-text")],C);export{v as U,p1 as a,P1 as b,P as c,x1 as e,E1 as i,c as n,H1 as r,y1 as t};
