...
<section className="ftco-section testimony-section" style={{background: "linear-gradient(45deg, #103514, #1a3216)"}}>
  <div className="container-xl">
    <div className="row justify-content-center pb-4">
      <div className="col-md-7 text-center heading-section" data-aos="fade-up" data-aos-duration="1000">
        <span className="subheading" style={{color:"white"}}></span>
        <h2 className="mb-3" style={{color:"white"}}>Our Features</h2>
      </div>
    </div>
    <div className="row">
          ...
          <div className="item">
            <div className="testimony-wrap">
              <div className="text">
                ...
                <p style={{color:"#222222", marginTop:"10px"}}>“Earnings shouldn’t depend on chance — they should depend on code.”</p>
              </div>
            </div>
          </div>
          ...
          <div className="item">
            <div className="testimony-wrap">
              <div className="text">
                ...
                <p style={{color:"#222222", marginTop:"10px"}}>“Your investment, your visibility — always on blockchain.”</p>
              </div>
            </div>
          </div>
          ...
          <div className="item">
            <div className="testimony-wrap">
              <div className="text">
                ...
                <p style={{color:"#222222", marginTop:"10px"}}> “We don’t build investors; we build believers.”</p>
              </div>
            </div>
          </div>
          ...
          <div className="item">
            <div className="testimony-wrap">
              <div className="text">
                ...
                <p style={{color:"#222222", marginTop:"10px"}}>“True leadership in crypto means accountability written in code.”</p>
              </div>
            </div>
          </div>
</Slider>
